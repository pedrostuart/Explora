// src/scripts/resetar-bloqueio.ts
// Script utilitário SÓ PARA DESENVOLVIMENTO/TESTES.
// Reseta o bloqueio de tentativas de login de um usuário específico.
// Uso: npm run resetar-bloqueio -- maria@teste.com
// (ou, após o build: node dist/scripts/resetar-bloqueio.js maria@teste.com)
